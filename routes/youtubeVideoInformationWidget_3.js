...
router.post('/', async function(req, res)
{
    ...
    res.render('dashboard', {
        ...
        youtubeVideoId_3 : youtubeVideoId,
        youtubeVideoPublishedDate_3 : youtubeVideoPublishedDate,
        youtubeVideoTitle_3 : youtubeVideoTitle,
        youtubeVideoChannelTitle_3 : youtubeVideoChannelTitle
    });
});
