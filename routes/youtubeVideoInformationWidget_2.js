...
router.post('/', async function(req, res)
{
    ...
    res.render('dashboard', {
        ...
        youtubeVideoId_2 : youtubeVideoId,
        youtubeVideoPublishedDate_2 : youtubeVideoPublishedDate,
        youtubeVideoTitle_2 : youtubeVideoTitle,
        youtubeVideoChannelTitle_2 : youtubeVideoChannelTitle
    });
});
